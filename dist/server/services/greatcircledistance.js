...
class DistancelengthService {
    constructor() {
        this.Pie = Math.PI; // The constant Pie is define As Math.PI
        this.RADIUS_OF_EARTH = 6371e3; //Approximated Radius of the Earth meters
        this.getRadians = coordinate => {
            return (coordinate * this.Pie) / 180;
        };
        this.greatCircleDistance = options => {
...
exports.default = DistancelengthService;
//# sourceMappingURL=greatcircledistance.js.map